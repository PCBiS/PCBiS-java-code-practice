...
public class Phoneinfor {
	...
	void numberAdd(String name, String phoneNum){	// 이름, 전화번호만을 입력받는 메소드		
	...
	void numberAdd(String name, String phoneNum, String birthDay) {	// 이름, 전화번호, 생년월일을 입력받는 오버로딩 메소드
		this.name = name;				// 클래스 변수 이름 = 입력받은 이름을 대입
		this.phoneNum = phoneNum;		// 클래스 변수 전화번호 = 입력받은 전화번호를 대입.
	...
	void showPbook() {	// 저장 된 정보를 출력하는 메소드
