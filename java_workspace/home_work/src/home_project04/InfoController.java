...
public class InfoController {
	...
	private PhoneInfor[] pInfo;	// PhoneInfor 클래스 형태의 배열 생성
	private int pIdx; // PhoneInfor를 통제할 기초 index 값 생성.	
	private Scanner sc;	
	...
	private void modifyInfo(int type, int pIdx) {		
		System.out.println("사용자 정보를 입력받습니다.");					
		System.out.println("이름을 입력해주세요 : ");
		this.name = sc.nextLine();
		System.out.println("전화번호를 입력해주세요 : ");
